...
def upload(
    ...
    if not exists_repo(repo_id=repo_id, repo_type=repo_type, token=token):
        ...
        except Exception as e:  # Verified RepositoryNotFoundError, but handle any exception defensively
            logger.error("===========================================")
    ...
    def uploader():
        ...
        except Exception as e:  # Observed RuntimeError; handle any exception defensively
            logger.error("===========================================")
